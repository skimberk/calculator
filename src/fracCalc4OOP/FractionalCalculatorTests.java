...
public class FractionalCalculatorTests 
{
	...
	{
		String response = ConsoleTester.getOutput("fracCalc4OOP.FractionalCalculator", "1_1/2 + 3/4\r\nquit");
	...
	{
		String response = ConsoleTester.getOutput("fracCalc4OOP.FractionalCalculator", "quit");
	...
	{
		String response = ConsoleTester.getOutput("fracCalc4OOP.FractionalCalculator", "1/3 + 2/3\r\n4/5 + 5/6\r\nquit");
	...
	{
		String response = ConsoleTester.getOutput("fracCalc4OOP.FractionalCalculator", "2/3 + 1/6\r\nquit");
		ArrayList<String> answers = getAnswersFromOutput(response);
		verify.that(answers.get(0))
			.isFraction()
			.isEquivalentTo("5/6");
	...
	{
		String response = ConsoleTester.getOutput("fracCalc4OOP.FractionalCalculator", "0 * 4_2/3\r\nquit");
		ArrayList<String> answers = getAnswersFromOutput(response);
		verify.that(answers.get(0))
			.isFraction()
			.isEquivalentTo("0");
	...
	{
		String response = ConsoleTester.getOutput("fracCalc4OOP.FractionalCalculator", "1_2/3 + 1/3\r\nquit");
		ArrayList<String> answers = getAnswersFromOutput(response);
	...
	{
		String response = ConsoleTester.getOutput("fracCalc4OOP.FractionalCalculator", "1_3/10 * -4\r\nquit");
		ArrayList<String> answers = getAnswersFromOutput(response);
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("42");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("3_7/8");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("9/10");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("7/3");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("0");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("-19");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("-1_2/3");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToFraction("-5/6");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.calculate("3/5", "+", "7/5");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.reduce("14/6");
		verify.that(output).equals("7/3");
	}
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.reduce("-9/6");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.reduce("0/3");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.reduce("3/17");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToMixed("6/1");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToMixed("-12/7");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToMixed("4/19");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToMixed("19/4");
	...
	{
		String output = fracCalc4OOP.FractionalCalculator.convertToMixed("0/1");
